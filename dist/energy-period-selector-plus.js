...
`;let De=class extends(oe(it)){constructor(){super(...arguments),this._compare=!1,this._lastSyncToEntityTimestamp=0,this._lastSyncFromEntityTimestamp=0,this._userActionTimestamp=0,this._isUserAction=!1,this._isProcessingClick=!1,this._lastClickId=0,this._clickDebounceTimer=null}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}async firstUpdated(){const t=await window.loadCardHelpers();t.importMoreInfoControl("input_datetime");try{await t.importMoreInfoControl("button")}catch(t){console.warn("Failed to load ha-button component:",t)}try{await t.importMoreInfoControl("selector")}catch(t){console.warn("Failed to load ha-selector component:",t)}const e=["button-toggle-group","ha-button-toggle-group","selector-button-toggle","ha-selector-button-toggle"];for(const o of e)try{await t.importMoreInfoControl(o);break}catch(t){console.warn(`Failed to load ${o}:`,t)}try{await t.importMoreInfoControl("button")}catch(t){console.warn("Failed to load ha-button component:",t)}setTimeout(()=>{this._forceButtonStyling()},1e3)}hassSubscribe(){var t,e;const o=[ee(this.hass,{key:this.collectionKey}).subscribe(t=>this._updateDates(t))];return((null===(t=this._config)||void 0===t?void 0:t.sync_entity)||(null===(e=this._config)||void 0===e?void 0:e.sync_entity_end))&&o.push(this.hass.connection.subscribeEvents(t=>this._handleEntityStateChange(t),"state_changed")),o}render(){var t,e,o,i,n,r,a,s,c,l,d,u,p,h,m;if(!this.hass||!this._startDate)return L;const _=t=>{var e;return"custom"===t?(null===(e=this._config)||void 0===e?void 0:e.custom_period_label)||Se(`toggleButtons.${t}`)||t:this.hass.localize(`ui.components.calendar.event.rrule.${t}`)},g=(null===(t=this._config)||void 0===t?void 0:t.period_buttons)?this._config.period_buttons.map(t=>({label:_(t),value:t})):[{label:this.hass.localize("ui.components.calendar.event.rrule.day"),value:"day"},{label:this.hass.localize("ui.components.calendar.event.rrule.week"),value:"week"},{label:this.hass.localize("ui.components.calendar.event.rrule.month"),value:"month"},{label:this.hass.localize("ui.components.calendar.event.rrule.year"),value:"year"}],y=(null===(e=this._config)||void 0===e?void 0:e.layout_mode)||"standard",f=j`
    ...
    >
    </ha-icon-button>`,x=!1===(null===(c=this._config)||void 0===c?void 0:c.today_button_type)?L:"icon"===(null===(l=this._config)||void 0===l?void 0:l.today_button_type)?b:v,w="icon"===(null===(d=this._config)||void 0===d?void 0:d.compare_button_type)?j`
      <ha-icon-button
      ...
      <div class="date-controls-row">
        ${"custom"===this._period?f:j`
              <div class="date-display">
                ${"day"===this._period?(E=this._startDate,D=this.hass.locale,Vt(D).format(E)):"month"===this._period?((t,e)=>Kt(e).format(t))(this._startDate,this.hass.locale):"year"===this._period?((t,e)=>Yt(e).format(t))(this._startDate,this.hass.locale):`${Ft(this._startDate,this.hass.locale)} – ${Ft(this._endDate||new Date,this.hass.locale)}`}
              </div>
    ...
    `;var E,D;const A=["energy-period-selector","compact"===y?"compact-mode":"standard-mode"].filter(Boolean).join(" ");return j`
      <div class="${A}">
        ${$}
        ${S}
        ${k}
      </div>
    `}_startDateChanged(t){this._setDate(new Date(t.detail.value))}_endDateChanged(t){this._startDate&&new Date(t.detail.value)>this._startDate&&this._setDate(this._startDate,new Date(t.detail.value))}_handleView(t){this._period=t.detail.value;const e=Pt(),o=!this._startDate||function(t,e){ut(2,arguments);var o=ht(t).getTime(),i=ht(e.start).getTime(),n=ht(e.end).getTime();if(!(i<=n))throw new RangeError("Invalid interval");return o>=i&&o<=n}(e,{start:this._startDate,end:this._endDate||Ct()})?e:this._startDate,i=jt(this.hass.locale);this._setDate("day"===this._period?wt(o):"week"===this._period?bt(o,{weekStartsOn:i}):"month"===this._period?At(o):"year"===this._period?Tt(o):this._startDate||Pt(),"custom"===this._period?this._endDate:void 0)}_pickToday(){const t=jt(this.hass.locale);this._setDate("day"===this._period?Pt():"week"===this._period?bt(new Date,{weekStartsOn:t}):"month"===this._period?At(new Date):Tt(new Date))}_pickPrevious(){const t=++this._lastClickId;this._clickDebounceTimer&&clearTimeout(this._clickDebounceTimer),this._clickDebounceTimer=window.setTimeout(()=>{this._processPickPrevious(t)},300)}_processPickPrevious(t){if(this._isProcessingClick)return;this._isProcessingClick=!0;const e="day"===this._period?mt(this._startDate,-1):"week"===this._period?$t(this._startDate,-1):"month"===this._period?_t(this._startDate,-1):"year"===this._period?St(this._startDate,-1):mt(this._startDate,-1);this._startDate&&Math.abs(e.getTime()-this._startDate.getTime())<1e3?this._isProcessingClick=!1:(this._userActionTimestamp=Date.now(),this._isUserAction=!0,this._setDate(e),setTimeout(()=>{this._isProcessingClick=!1},500))}_pickNext(){const t=++this._lastClickId;this._clickDebounceTimer&&clearTimeout(this._clickDebounceTimer),this._clickDebounceTimer=window.setTimeout(()=>{this._processPickNext(t)},300)}_processPickNext(t){if(this._isProcessingClick)return;this._isProcessingClick=!0;const e="day"===this._period?mt(this._startDate,1):"week"===this._period?$t(this._startDate,1):"month"===this._period?_t(this._startDate,1):"year"===this._period?St(this._startDate,1):mt(this._startDate,1);this._startDate&&Math.abs(e.getTime()-this._startDate.getTime())<1e3?this._isProcessingClick=!1:(this._userActionTimestamp=Date.now(),this._isUserAction=!0,this._setDate(e),setTimeout(()=>{this._isProcessingClick=!1},500))}_setDate(t,e,o=!1){this._startDate=t;const i=jt(this.hass.locale),n="day"===this._period?Dt(t):"week"===this._period?function(t,e){var o,i,n,r,a,s,c,l;ut(1,arguments);var d=vt(),u=dt(null!==(o=null!==(i=null!==(n=null!==(r=null==e?void 0:e.weekStartsOn)&&void 0!==r?r:null==e||null===(a=e.locale)||void 0===a||null===(s=a.options)||void 0===s?void 0:s.weekStartsOn)&&void 0!==n?n:d.weekStartsOn)&&void 0!==i?i:null===(c=d.locale)||void 0===c||null===(l=c.options)||void 0===l?void 0:l.weekStartsOn)&&void 0!==o?o:0);if(!(u>=0&&u<=6))throw new RangeError("weekStartsOn must be between 0 and 6 inclusively");var p=ht(t),h=p.getDay(),m=6+(h<u?-7:0)-(h-u);return p.setDate(p.getDate()+m),p.setHours(23,59,59,999),p}(t,{weekStartsOn:i}):"month"===this._period?function(t){ut(1,arguments);var e=ht(t),o=e.getMonth();return e.setFullYear(e.getFullYear(),o+1,0),e.setHours(23,59,59,999),e}(t):"year"===this._period?function(t){ut(1,arguments);var e=ht(t),o=e.getFullYear();return e.setFullYear(o+1,0,0),e.setHours(23,59,59,999),e}(t):"custom"===this._period&&e?Dt(e):this._endDate||Ct(),r=ee(this.hass,{key:this.collectionKey});r.setPeriod(t,n),r.refresh(),o||this._syncToEntity()}_updateDates(t){this._compare=void 0!==t.startCompare,this._startDate=t.start,this._endDate=t.end||Ct();const e=Et(this._endDate,this._startDate||Ct());this._period="custom"!==this._period?e<1?"day":6===e?"week":e>26&&e<31?"month":364===e||365===e?"year":"custom":"custom"}_toggleCompare(){this._compare=!this._compare;const t=ee(this.hass,{key:this.collectionKey});t.setCompare(this._compare),t.refresh()}_handleEntityStateChange(t){var e,o,i;const n=(null===(e=this._config)||void 0===e?void 0:e.sync_entity)&&t.data.entity_id===this._config.sync_entity,r=(null===(o=this._config)||void 0===o?void 0:o.sync_entity_end)&&t.data.entity_id===this._config.sync_entity_end;if(!n&&!r)return;const a=(null===(i=this._config)||void 0===i?void 0:i.sync_direction)||"both";if("from-entity"!==a&&"both"!==a)return;const s=Date.now();if(s-this._lastSyncFromEntityTimestamp<500)return;if(s-this._userActionTimestamp<1e3)return;if(this._isUserAction)return;const c=t.data.new_state;if(!c||!c.attributes)return;const l=this._parseEntityDateTime(c);if(l)if(n){if(this._startDate&&Math.abs(l.getTime()-this._startDate.getTime())<1e3)return;this._lastSyncFromEntityTimestamp=s,this._setDate(l,void 0,!0)}else if(r){if(this._endDate&&Math.abs(l.getTime()-this._endDate.getTime())<1e3)return;this._lastSyncFromEntityTimestamp=s,this._startDate&&l>=this._startDate&&this._setDate(this._startDate,l,!0)}}_parseEntityDateTime(t){try{if(t.attributes.has_date&&t.attributes.has_time){const e=t.attributes.year+"-"+String(t.attributes.month).padStart(2,"0")+"-"+String(t.attributes.day).padStart(2,"0"),o=String(t.attributes.hour).padStart(2,"0")+":"+String(t.attributes.minute).padStart(2,"0")+":00";return new Date(e+"T"+o)}if(t.attributes.has_date){const e=t.attributes.year+"-"+String(t.attributes.month).padStart(2,"0")+"-"+String(t.attributes.day).padStart(2,"0");return new Date(e+"T00:00:00")}if("string"==typeof t.state){const e=new Date(t.state);if(!isNaN(e.getTime()))return e}return null}catch(t){return console.warn("Failed to parse entity date:",t),null}}_syncToEntity(){var t,e,o;if(!this._startDate)return;const i=(null===(t=this._config)||void 0===t?void 0:t.sync_direction)||"both";if("to-entity"!==i&&"both"!==i)return;const n=Date.now();if(!(n-this._lastSyncToEntityTimestamp<500)){if(this._lastSyncToEntityTimestamp=n,null===(e=this._config)||void 0===e?void 0:e.sync_entity){const t=this._formatDateForEntity(this._startDate);t&&this.hass.callService("input_datetime","set_datetime",Object.assign({entity_id:this._config.sync_entity},t)).catch(t=>{console.warn("Failed to sync start date to entity:",t)})}if((null===(o=this._config)||void 0===o?void 0:o.sync_entity_end)&&this._endDate){const t=this._formatDateForEntity(this._endDate);t&&this.hass.callService("input_datetime","set_datetime",Object.assign({entity_id:this._config.sync_entity_end},t)).catch(t=>{console.warn("Failed to sync end date to entity:",t)})}setTimeout(()=>{this._isUserAction=!1},2e3)}}_formatDateForEntity(t){try{const e=t.getFullYear(),o=String(t.getMonth()+1).padStart(2,"0"),i=String(t.getDate()).padStart(2,"0");return{datetime:`${e}-${o}-${i} ${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}:00`}}catch(t){return console.warn("Failed to format date for entity:",t),null}}_renderPeriodButtons(t){return j`
    ...
    `}_onSelectorUpdated(){this._forceButtonStyling(),setTimeout(()=>{this._forceButtonStyling()},500)}_forceButtonStyling(){setTimeout(()=>{var t,e;const o=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("ha-selector");o&&o.querySelectorAll("mwc-button").forEach(t=>{t.style.setProperty("--mdc-button-height","20px","important"),t.style.setProperty("--mdc-button-min-width","40px","important"),t.style.setProperty("--mdc-typography-button-font-size","11px","important"),t.style.setProperty("--mdc-typography-button-font-weight","500","important"),t.style.setProperty("--mdc-typography-button-text-transform","uppercase","important"),t.style.setProperty("--mdc-button-outline-color","#202124","important"),t.style.setProperty("--mdc-theme-primary","#d2d3d3","important"),t.style.height="20px",t.style.minWidth="40px",t.style.fontSize="11px",t.style.fontWeight="500",t.style.textTransform="uppercase",t.style.border="1px solid #202124"});const i=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelectorAll(".navigation-controls ha-icon-button, .navigation-controls ha-icon-button-prev, .navigation-controls ha-icon-button-next");null==i||i.forEach(t=>{t.style.setProperty("--mdc-icon-button-size","20px","important"),t.style.height="20px",t.style.width="20px",t.style.minHeight="20px",t.style.minWidth="20px",t.style.maxHeight="20px",t.style.maxWidth="20px",t.style.padding="0",t.style.margin="0",t.style.lineHeight="20px",t.style.display="inline-flex",t.style.alignItems="center",t.style.justifyContent="center",t.style.verticalAlign="middle",t.style.position="relative",t.style.top="0",t.style.transform="none",t.style.border="none",t.style.outline="none",t.style.boxShadow="none",t.querySelectorAll("button, mwc-icon-button, .mdc-icon-button").forEach(t=>{t.style.height="20px",t.style.width="20px",t.style.minHeight="20px",t.style.minWidth="20px",t.style.maxHeight="20px",t.style.maxWidth="20px",t.style.padding="0",t.style.margin="0",t.style.display="inline-flex",t.style.alignItems="center",t.style.justifyContent="center",t.style.verticalAlign="middle",t.style.setProperty("--mdc-icon-button-size","20px","important")})})},100)}updated(t){super.updated(t),this._onSelectorUpdated()}};var Ae,Te;De.styles=Ee,t([st({attribute:!1})],De.prototype,"hass",void 0),t([ct()],De.prototype,"_config",void 0),t([st()],De.prototype,"collectionKey",void 0),t([ct()],De.prototype,"_startDate",void 0),t([ct()],De.prototype,"_endDate",void 0),t([ct()],De.prototype,"_period",void 0),t([ct()],De.prototype,"_compare",void 0),t([ct()],De.prototype,"_lastSyncToEntityTimestamp",void 0),t([ct()],De.prototype,"_lastSyncFromEntityTimestamp",void 0),t([ct()],De.prototype,"_userActionTimestamp",void 0),t([ct()],De.prototype,"_isUserAction",void 0),t([ct()],De.prototype,"_isProcessingClick",void 0),De=t([rt("energy-period-selector-base")],De),function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(Ae||(Ae={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(Te||(Te={}));var Ce=function(t,e,o,i){i=i||{},o=null==o?{}:o;var n=new Event(e,{bubbles:void 0===i.bubbles||i.bubbles,cancelable:Boolean(i.cancelable),composed:void 0===i.composed||i.composed});return n.detail=o,t.dispatchEvent(n),n},Pe="0.2.5";console.groupCollapsed(`%c⚡ Energy Period Selector Plus v${Pe} is installed`,"color: #488fc2; font-weight: bold"),console.log("Readme:","https://github.com/talKitron/energy-period-selector-plus"),console.groupEnd();const Me=function(t,e,o){var i;return void 0===o&&(o=!1),function(){var e=[].slice.call(arguments),n=this,r=o&&!i;clearTimeout(i),i=setTimeout(function(){i=null,o||t.apply(n,e)},6e4),r&&t.apply(n,e)}}(t=>{console.log(`%c⚡ Energy Period Selector Plus v${Pe} %cError: ${t}`,"color: #488fc2; font-weight: bold","color: #b33a3a; font-weight: normal")});!function(){const t=window;t.customCards=t.customCards||[],t.customCards.push(Object.assign(Object.assign({},{type:"energy-period-selector-plus",name:"Energy Period Selector Plus",description:"A custom card to change the Energy Period of your Energy Data."}),{preview:!0,documentationURL:"https://github.com/flixlix/energy-period-selector-plus"}))}();let He=class extends it{getCardSize(){return 1}static async getConfigElement(){return await Promise.resolve().then(function(){return Qe}),document.createElement("energy-period-selector-editor")}setConfig(t){this._config=t}render(){var t,e,o,i;if(!this.hass||!this._config)return Me(Se("common.invalid_configuration")||"Invalid configuration"),L;const n="compact"===((null===(t=this._config)||void 0===t?void 0:t.layout_mode)||"standard"),r=j` <energy-period-selector-base .hass=${this.hass} ._config=${this._config} .collectionKey=${null===(e=this._config)||void 0===e?void 0:e.collection_key}></energy-period-selector-base> `;return n?r:(null===(o=this._config)||void 0===o?void 0:o.card_background)?j` <ha-card .header=${null===(i=this._config)||void 0===i?void 0:i.title}> ${r}</ha-card> `:j` ${r} `}};He.styles=ke,t([st({attribute:!1})],He.prototype,"hass",void 0),t([st({attribute:!1})],He.prototype,"locale",void 0),t([ct()],He.prototype,"_config",void 0),He=t([rt("energy-period-selector-plus")],He);class ze extends TypeError{constructor(t,e){let o;const{message:i,explanation:n,...r}=t,{path:a}=t,s=0===a.length?i:`At path: ${a.join(".")} -- ${i}`;super(n??s),null!=n&&(this.cause=s),Object.assign(this,r),this.name=this.constructor.name,this.failures=()=>o??(o=[t,...e()])}}function Ne(t){return"object"==typeof t&&null!=t}function Oe(t){return Ne(t)&&!Array.isArray(t)}function Ie(t){return"symbol"==typeof t?t.toString():"string"==typeof t?JSON.stringify(t):`${t}`}function je(t,e,o,i){if(!0===t)return;!1===t?t={}:"string"==typeof t&&(t={message:t});const{path:n,branch:r}=e,{type:a}=o,{refinement:s,message:c=`Expected a value of type \`${a}\`${s?` with refinement \`${s}\``:""}, but received: \`${Ie(i)}\``}=t;return{value:i,type:a,refinement:s,key:n[n.length-1],path:n,branch:r,...t,message:c}}function*Be(t,e,o,i){(function(t){return Ne(t)&&"function"==typeof t[Symbol.iterator]})(t)||(t=[t]);for(const n of t){const t=je(n,e,o,i);t&&(yield t)}}function*Le(t,e,o={}){const{path:i=[],branch:n=[t],coerce:r=!1,mask:a=!1}=o,s={path:i,branch:n,mask:a};r&&(t=e.coercer(t,s));let c="valid";for(const i of e.validator(t,s))i.explanation=o.message,c="not_valid",yield[i,void 0];for(let[l,d,u]of e.entries(t,s)){const e=Le(d,u,{path:void 0===l?i:[...i,l],branch:void 0===l?n:[...n,d],coerce:r,mask:a,message:o.message});for(const o of e)o[0]?(c=null!=o[0].refinement?"not_refined":"not_valid",yield[o[0],void 0]):r&&(d=o[1],void 0===l?t=d:t instanceof Map?t.set(l,d):t instanceof Set?t.add(d):Ne(t)&&(void 0!==d||l in t)&&(t[l]=d))}if("not_valid"!==c)for(const i of e.refiner(t,s))i.explanation=o.message,c="not_refined",yield[i,void 0];"valid"===c&&(yield[void 0,t])}class Re{constructor(t){const{type:e,schema:o,validator:i,refiner:n,coercer:r=t=>t,entries:a=function*(){}}=t;this.type=e,this.schema=o,this.entries=a,this.coercer=r,this.validator=i?(t,e)=>Be(i(t,e),e,this,t):()=>[],this.refiner=n?(t,e)=>Be(n(t,e),e,this,t):()=>[]}assert(t,e){return Ue(t,this,e)}create(t,e){return function(t,e,o){const i=Ve(t,e,{coerce:!0,message:o});if(i[0])throw i[0];return i[1]}(t,this,e)}is(t){return function(t,e){return!Ve(t,e)[0]}(t,this)}mask(t,e){return function(t,e,o){const i=Ve(t,e,{coerce:!0,mask:!0,message:o});if(i[0])throw i[0];return i[1]}(t,this,e)}validate(t,e={}){return Ve(t,this,e)}}function Ue(t,e,o){const i=Ve(t,e,{message:o});if(i[0])throw i[0]}function Ve(t,e,o={}){const i=Le(t,e,o),n=function(t){const{done:e,value:o}=t.next();return e?void 0:o}(i);if(n[0]){return[new ze(n[0],function*(){for(const t of i)t[0]&&(yield t[0])}),void 0]}return[void 0,n[1]]}function Fe(t,e){return new Re({type:t,schema:null,validator:e})}function We(){return Fe("any",()=>!0)}function Ke(){return Fe("boolean",t=>"boolean"==typeof t)}function Ye(t){const e=t?Object.keys(t):[],o=Fe("never",()=>!1);return new Re({type:"object",schema:t||null,*entries(i){if(t&&Ne(i)){const n=new Set(Object.keys(i));for(const o of e)n.delete(o),yield[o,i[o],t[o]];for(const t of n)yield[t,i[t],o]}},validator:t=>Oe(t)||`Expected an object, but received: ${Ie(t)}`,coercer(e,o){if(!Oe(e))return e;const i={...e};if(o.mask&&t)for(const e in i)void 0===t[e]&&delete i[e];return i}})}function Ze(t){return new Re({...t,validator:(e,o)=>void 0===e||t.validator(e,o),refiner:(e,o)=>void 0===e||t.refiner(e,o)})}function Ge(){return Fe("string",t=>"string"==typeof t||`Expected a string, but received: ${Ie(t)}`)}const Je=async()=>{var t,e;if(customElements.get("ha-form"))return;const o=await(null===(e=(t=window).loadCardHelpers)||void 0===e?void 0:e.call(t));if(!o)return;const i=await o.createCardElement({type:"entity"});i&&await i.getConfigElement()};let qe=class extends it{constructor(){super(...arguments),this._schema=Ut((t,e)=>[{type:"grid",name:"",schema:[{name:"card_background",selector:{boolean:{}}},{name:"prev_next_buttons",selector:{boolean:{}}}]},{name:"layout_mode",selector:{select:{options:[{value:"standard",label:Se("editor.fields.layout_mode_options.standard")},{value:"compact",label:Se("editor.fields.layout_mode_options.compact")}],mode:"dropdown"}}},{type:"grid",name:"",schema:[{name:"compare_button_type",selector:{select:{options:[{value:"",label:""},{value:"icon",label:Se("editor.fields.compare_button_options.icon")},{value:"text",label:Se("editor.fields.compare_button_options.text")}],mode:"dropdown"}}},...t?[{name:"compare_button_label",selector:{text:{}}}]:[]]},{name:"today_button_type",selector:{select:{options:[{value:!1,label:""},{value:"icon",label:Se("editor.fields.compare_button_options.icon")},{value:"text",label:Se("editor.fields.compare_button_options.text")}],mode:"dropdown"}}},{type:"grid",name:"",schema:[{type:"multi_select",options:{day:Se("editor.fields.period_buttons_options.day"),week:Se("editor.fields.period_buttons_options.week"),month:Se("editor.fields.period_buttons_options.month"),year:Se("editor.fields.period_buttons_options.year"),custom:Se("editor.fields.period_buttons_options.custom")},name:"period_buttons",default:["day","week","month","year"]},...e?[{name:"custom_period_label",selector:{text:{}}}]:[]]}]),this._computeLabelCallback=t=>Se(`editor.fields.${t.name}`)||`not found: ${t.name}`}async setConfig(t){Ue(t,function(...t){const e="type"===t[0].type,o=t.map(t=>t.schema),i=Object.assign({},...o);return e?function(t){const e=Object.keys(t);return new Re({type:"type",schema:t,*entries(o){if(Ne(o))for(const i of e)yield[i,o[i],t[i]]},validator:t=>Oe(t)||`Expected an object, but received: ${Ie(t)}`,coercer:t=>Oe(t)?{...t}:t})}(i):Ye(i)}(Ye({type:Ge(),view_layout:Ze(Ge())}),Ye({card_background:Ze(Ke()),today_button:Ze(Ke()),prev_next_buttons:Ze(Ke()),compare_button_type:Ze(Ge()),today_button_type:Ze(We()),period_buttons:Ze(We()),custom_period_label:Ze(Ge()),compare_button_label:Ze(Ge()),sync_entity:Ze(Ge()),sync_entity_end:Ze(Ge()),sync_direction:Ze(Ge()),layout_mode:Ze(Ge())}))),this._config=t}connectedCallback(){super.connectedCallback(),Je()}render(){var t,e,o,i,n,r,a,s,c,l,d;if(!this.hass||!this._config)return L;const u=Object.assign(Object.assign({},this._config),{card_background:null!==(t=this._config.card_background)&&void 0!==t&&t,today_button:null===(e=this._config.today_button)||void 0===e||e,prev_next_buttons:null===(o=this._config.prev_next_buttons)||void 0===o||o,compare_button_type:null!==(i=this._config.compare_button_type)&&void 0!==i?i:"",today_button_type:null!==(n=this._config.today_button_type)&&void 0!==n?n:"text",period_buttons:null!==(r=this._config.period_buttons)&&void 0!==r?r:["day","week","month","year"],sync_entity:null!==(a=this._config.sync_entity)&&void 0!==a?a:"",sync_entity_end:null!==(s=this._config.sync_entity_end)&&void 0!==s?s:"",sync_direction:null!==(c=this._config.sync_direction)&&void 0!==c?c:"both",layout_mode:null!==(l=this._config.layout_mode)&&void 0!==l?l:"standard"}),p=this._schema("text"===u.compare_button_type,(null!==(d=u.period_buttons)&&void 0!==d?d:[]).includes("custom"));return j`
      ...
      ${this._renderSyncRow(u)}
    `}_valueChanged(t){const e=null==t?void 0:t.detail.value;Ce(this,"config-changed",{config:e})}_renderSyncRow(t){var e,o,i;return j`
      <div class="two-col">
        <div class="field">
        ...
        <div class="field">
          <div class="caption">${Se("editor.fields.sync_entity_end")}</div>
          <ha-selector
            .hass=${this.hass}
            .selector=${{entity:{domain:["input_datetime"]}}}
            .value=${null!==(o=t.sync_entity_end)&&void 0!==o?o:""}
            @value-changed=${t=>this._patch("sync_entity_end",t.detail.value||"")}
          ></ha-selector>
        </div>
      </div>
      ...
      <div class="two-col">
        <div class="field">
          ...
          <ha-selector
            ...
            .value=${null!==(i=t.sync_direction)&&void 0!==i?i:"both"}
